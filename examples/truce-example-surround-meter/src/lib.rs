...
impl PluginLogic for SurroundMeter {
    ...
    fn process(
        ...
        let trim_lin = db_to_linear(self.params.trim.read());
...
mod tests {
    ...
    fn gui_screenshot_macos() {
        truce_test::screenshot!(Plugin, "screenshots/surround_meter_default_macos.png").run();
    }

    #[cfg(target_os = "linux")]
    #[test]
    fn gui_screenshot_linux() {
        truce_test::screenshot!(Plugin, "screenshots/surround_meter_default_linux.png")
            .pixel_threshold(2)
            .run();
    }
    ...
    fn gui_screenshot_windows() {
        truce_test::screenshot!(Plugin, "screenshots/surround_meter_default_windows.png")
            .pixel_threshold(2)
            .run();
    }
}
