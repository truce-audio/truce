...
> Note: the engine used to live in a separate `truce-xtask` crate;
> it was merged into cargo-truce in 0.13.x to reduce the published
> surface and keep help / dispatch / scaffolding in one place.
