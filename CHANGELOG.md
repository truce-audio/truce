...
- New constructors: `BusLayout::mono()` (mirrors `BusLayout::stereo()`) and `BusLayout::stereo_and_mono()` (the default audio-effect set - stereo and mono).
